...
class KOOWEXACore {
  ...
  setupMainButtons() {
    // Los botones principales de acción (mainMenuBtn, mainBotBtn) se manejan en main-actions.js
    // El botón 'Comenzar Ahora' (#startBtn) se maneja en comenzar.js para una lógica más robusta.
  }

  setupKeyboardNavigation() {
    const buttons = document.querySelectorAll(
      "button, .menu-btn, .social-link, .email-btn",
    );
  ...
  trackPageView() {
    if (window.KOOWEXA_API && window.KOOWEXA_API.getAPI("analytics")) {
      window.KOOWEXA_API.getAPI("analytics").trackPageView(
